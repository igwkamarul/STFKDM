...
$mm = mysql_query("select * from add_fasiliti where id = '".$_SESSION['get_id']."' and no_tempahan = '".$_SESSION['get_no_tempah']."'");
...
if($rows_available < 1){*/
?>
<form action="test.php" method="post" name="step">
  <?php
		
			$fas = $_POST['fasiliti'];
			$mula = $_POST['tarikh_mula'];
			$tmt = $_POST['tarikh_akhir'];
  ...
  <tr>
    ...
    <table border="0" width="100%" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="11%" align="center"><input type="text" name="T1" size="6"  value="<?php echo $jj['bil_pa'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" autofocus="autofocus" /></td>
					...
					<tr>
						...
						<td width="17%" align="center">RM&nbsp;150.00</td>
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T2" size="6" value="<?php echo $jj['bil_lcd'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
					...
					<tr>
						...
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T3" size="6" value="<?php echo $jj['bil_mbulat'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
					...
					<tr>
						...
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T4" size="6" value="<?php echo $jj['bil_mbuffet'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
					...
					<tr>
						...
						<td width="17%" align="center">RM&nbsp;4.00</td>
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T5" size="6" value="<?php echo $jj['bil_moblong'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
					...
					<tr>
						...
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T6" size="6" value="<?php echo $jj['bil_banquet'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
					...
					<tr>
						...
						<td width="2%" align="center">x</td>
						<td width="11%" align="center"><input type="text" name="T7" size="6" value="<?php echo $jj['bil_kplastik'];?>" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" /></td>
