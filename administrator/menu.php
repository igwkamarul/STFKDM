<nav id="menu-wrap"><div id="menu-trigger">Menu</div>    
	<ul id="menu">
		...
		<li><a href="">Tempahan</a>
        <ul>
			<li><a href="lulus.php">Lulus</a></li>
			<li><a href="belum_lulus.php">Belum Lulus</a></li>
			<li><a href="gagal.php">Dibatalkan</a></li>
		</ul>		
		</li>
        <li><a href="penempah.php">Penempah</a></li>
        <li><a href="maklumat_tempahan.php">Maklumat Tempahan</a></li>
