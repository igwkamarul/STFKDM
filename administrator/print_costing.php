...
</script><body onsload="window.print(); window.close();">
<center>
<p>  <br>
 <?php include("banner.php");?></p>
...
$sql = mysql_query("select * from add_fasiliti WHERE id_fasiliti ='".$dFas['id_fasiliti']."' AND no_tempahan='".$_REQUEST['no_tempahan']."' AND status_approve = 2   group by id");
  ...
  <td align="center"><?=$dCosting['kos_pax_mnmlm'];?></td>
		  ...
		  <td>(VIP)</td>
		    ...
		    <td align="center"><?=$dCosting['qty_vip_mnmlm'];?></td>
			  <td align="center"><?=$dCosting['sesi_mnmlm'];?></td>
			    <td align="center">-</td>
				  <td align="center"><?=number_format($dCosting['kos_vip_mnmlm']*$dCosting['qty_vip_mnmlm']*$dCosting['sesi_mnmlm'],2);$totaljual=$totaljual+($dCosting['kos_vip_mnmlm']*$dCosting['qty_vip_mnmlm']*$dCosting['sesi_mnmlm']);?></td>
  ...
  <td align="center"><?=$dCosting['misc_kos'];?></td>
    ...
    <td align="center"><?=$dPnmhn['qty_meja_bulat'];?></td>
			  <td align="center"></td>
			    <td align="center"></td>
				  <td align="center"><?=$dPnmhn['jumlah_kos_meja_bulat'];$totaljual=$totaljual+$dPnmhn['jum_harga_meja_bulat'];?></td>
