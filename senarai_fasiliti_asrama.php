...
<div class="ff-page">
 ...
 <div class="ff-gr ff-clear">
			...
			?>
				...
				<tr style="cursor: pointer;"  onMouseOver="this.style.backgroundColor='#f5f7fb'"; onMouseOut="this.style.backgroundColor='transparent'" onclick="window.location='tempahan_asrama_mula.php?id_fasiliti=<?php echo $row['id_fasiliti']; ?>'" title="Klik Untuk Pilih Fasiliti">
