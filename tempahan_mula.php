...
$tarikh_tamat = date('Y-m-d', strtotime($_POST['trktamat'])); 
	...
	echo "<script type='text/javascript'>";
		echo "alert('Tempahan Anda Pilih Sudah Penuh. Sila pilih tarikh lain.')";
		echo "</script>";
		echo "<meta http-equiv='refresh' content='0;url=tempahan_mula.php?id_fasiliti=$id_fasiliti'>";
	
	}
	
//$check_available = mysql_query("select * from add_fasiliti where tarikh BETWEEN '$d1' AND '$d2' and  id_fasiliti  ='$id_fasiliti' and status_approve = 2");
